...
Two tiers, roughly in order. Tier 1 gets you from nothing to a working
multi-camera recording. Tier 2 is everything past that: a trustworthy
calibration, choosing a tracker, cleaning your data, and going further
with the data or the pipeline itself.
