...
reviewed: 2026-08-24
reviewed_against: "FreeMoCap-docs/docs/proposals/centroidal-kinematics/00-overview.mdx in the FreeMoCap clone (v2.0.0-alpha.21), read directly"
draft: false
---
...
validation path remain planned (phases P3 and P4). Treat this as a live
status, not a fixed one, and check the source directly rather than this
summary before relying on which parts are actually implemented.
